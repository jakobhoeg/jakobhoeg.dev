...
export default function LinkedInCard() {
  return (
   ...
   className='relative h-full gap-6 overflow-hidden rounded-xl  p-4 col-start-3 col-span-2 row-start-2  ring-1 ring-neutral-200 ring-offset-8 ring-offset-neutral-100 dark:ring-neutral-950/10 dark:ring-offset-neutral-950/10'>
