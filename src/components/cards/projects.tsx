...
export default function ProjectsCard() {
  ...
  return (
    <motion.div
      ...
      className="relative h-full cursor-pointer overflow-hidden gap-6 md:h-40 flex  rounded-xl bg-white/75 dark:bg-muted/80 col-start-1 row-start-2 row-span-1 col-span-9 md:col-start-5 md:col-span-3 md:row-start-2 ring-1 ring-neutral-200 ring-offset-8 ring-offset-neutral-100 dark:ring-neutral-950/10 dark:ring-offset-neutral-950/10"
